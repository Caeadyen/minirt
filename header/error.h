...
#define PARSINGERROR 3
#define AMLIGHTFORMAT 4
#define AMLIGHTRATIO 5
#define AMLIGHTMULTI 6
#define AMLIGHTRANGE 7
#define AMLIGHTCOLOR 8
#define CAMFORMAT 9
#define CAMPOSITION 10
#define CAMMULTI 11
#define CAMORITATION 12
#define CAMFOV 13
